...
| -o      | -output | String | NULL | output file name (.sam or other) |
...
By default, WALT produces MR format files. If you plan to get SAM file, please make sure the suffix of the output file is ".sam".
